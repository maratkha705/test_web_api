...
class SiteDataService(SiteDataInterface):
    ...
    async def get_data(self):
        ...
        try:
            ...
            logger.debug(f"SiteConfig: {ex} {self.repo.db_name}")
            site_config = {
                "ex": f"Fail: {ex}"
            }
    ...
    async def update_document(self, doc_id: int, components: dict[int: str],):
        raise ApiBaseException(message="Method not implemented", status_code=404)
